...
export default function AssistantPanel({ recommendation, title }: { recommendation: RouteRecommendation, title?: string }) {
  return (
    <div className="glass-panel animate-fade-up delay-2" style={{ 
      padding: '24px', 
      margin: '16px 0', 
      ...
      <div>
        ...
        <ul style={{ listStyleType: 'none', paddingLeft: 0, position: 'relative' }}>
          <div style={{ position: 'absolute', left: '11px', top: '24px', bottom: '24px', width: '2px', background: 'var(--surface-border-bright)' }}></div>
