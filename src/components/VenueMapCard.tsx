export default function VenueMapCard({ recommendedZone }: { recommendedZone?: string }) {
  return (
    <section
      aria-label="Venue map preview"
      className="glass-panel animate-fade-up delay-1"
      style={{
        width: '100%',
        height: '280px',
        overflow: 'hidden',
    ...
    >
      <div style={{ width: '100%', height: '100%', borderRadius: '18px', overflow: 'hidden', position: 'relative' }}>
        <iframe
          title="Google Maps venue overview"
          width="100%"
          height="100%"
        ...
        {recommendedZone && (
          ...
          >
            <span
              aria-hidden="true"
              style={{ display: 'inline-block', width: '10px', height: '10px', background: 'var(--primary)', borderRadius: '50%', boxShadow: '0 0 10px var(--primary)' }}
            ></span>
